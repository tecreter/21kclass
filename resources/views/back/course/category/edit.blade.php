                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select name="type_id" id="type_id" class="form-control @error('type_id') is-invalid @enderror" autofocus required>
                                                                    ...
                                                                    <option value="1" {{ (old('type_id', $courseCategory->type_id) == 1) ? ' selected' : '' }}>Coaching</option>
                                                                    <option value="2" {{ (old('type_id', $courseCategory->type_id) == 2) ? ' selected' : '' }}>Tutoring</option>
                                                                    <option value="3" {{ (old('type_id', $courseCategory->type_id) == 3) ? ' selected' : '' }}>Commerce</option>
                                                                </select>
                                                                @error('type_id')
