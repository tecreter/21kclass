    ...
    <main id="content" role="main">
        ...
        <div class="container space-top-3 space-top-lg-4 space-bottom-2 space-bottom-lg-3">
            <div class="w-lg-80 mx-auto">
                <div class="mb-5">
                    <a class="font-weight-bold" href="{{ route('work-with-us', [ '#openRolesSection' ]) }}">
                ...
                <div class="card space-bottom-2 p-4 p-md-7">
                    ...
                    <div class="mb-5">
                        ...
                        <ul>
                            ...
                            <li>Experience in Architecture and Solution design for customer engagements in the Identity/Security space, including cloud security concepts.</li>
                            <li>Drive Solution Architecture for customer requirements with estimation, staffing plan and schedule planning.</li>
                        </ul>
                    </div>
