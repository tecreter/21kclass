    ...
    <main id="content" role="main">
        ...
        <div class="bg-img-hero-center" style="background-image: url('/images/banners/banner-jee.jpeg');background-color: rgba(0, 0, 0, 0.4)">
            <div class="container space-2 space-sm-3 space-md-4 min-vw-100" style="background-color: rgba(0, 0, 0, 0.45);">
                <div class="w-xs-auto text-center">
                    <div class="mb-4">
                        <h2 class="h1 text-white">JEE tutoring</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container space-top-1 space-top-lg-2">
            ...
            <div class="container space-top-1 space-bottom-1">
                ...
                <p>We provide the structured Learning experience and a robust practice for the JEE aspirants in our Online tutoring Program. Our Program focuses on the Conceptual understanding and clarity of the students and the continuous practice and assessments pave you a way for your success in JEE Exam.</p>
                ...
                <p>Our Goal is to take our tutoring Classes to the students wherever they live, irrespective of their geographical location and enable them to study and prepare for the JEE.</p>
            </div>
        </div>
