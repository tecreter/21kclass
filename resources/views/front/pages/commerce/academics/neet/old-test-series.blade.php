    ...
    <main id="content" role="main">
        ...
        <div class="container space-top-3 space-top-lg-4 space-bottom-2">
            <div class="row align-items-lg-center">
                ...
                <div class="col-lg-7">
                    <img class="img-fluid" src="/images/commerce/svg/illustrations/we-are-in-office-1.svg" alt="Image Description">
                </div>
            </div>
        </div>
                    ...
                    <div class="position-relative min-h-500rem mx-auto" style="max-width: 28rem;">
                      ...
                      c123.6,0,223.7,100.2,223.7,223.7l0,0C448.7,348.6,348.5,448.7,225,448.7z"/>
                                    ...
                                    <g clip-path="url(#circleImgID1)">
                                        <image width="450" height="450" xlink:href="/images/commerce/450x450/img1.jpg" ></image>
                                    </g>
                                </g>
                            </svg>
                        </figure>
                      ...
                      C515,400.9,400.8,515,260,515z"/>
                                    ...
                                    <g clip-path="url(#circleImgID3)">
                                        <image width="515" height="515" xlink:href="/images/commerce/515x515/img1.jpg" transform="matrix(1 0 0 1 1.639390e-02 2.880859e-02)"></image>
                                    </g>
                                </g>
                            </svg>
                        </figure>
                      ...
                      C172.5,0,0,172.5,0,385.2l0,0C0,597.9,172.4,770.4,385.2,770.4z"/>
                                    ...
                                    <g clip-path="url(#circleImgID5)">
                                        <image width="900" height="900" xlink:href="/images/commerce/900x900/img2.jpg" transform="matrix(1 0 0 1 -64.8123 -64.8055)"></image>
                                    </g>
                                </g>
                            </svg>
                        </figure>
        ...
        <div class="position-relative">
            <div class="bg-img-hero" style="background-image: url('/images/commerce/svg/components/abstract-shapes-12.svg');">
                    ...
                    <div class="row">
                            ...
                            <div class="card text-center h-100 transition-3d-hover">
                                <div class="card-body p-lg-5">
                                    <figure class="max-w-8rem w-100 mx-auto mb-4">
                                        <img class="img-fluid" src="/images/commerce/svg/icons/icon-26.svg" alt="SVG">
                                    </figure>
                        ...
                        <div class="col-md-4 mb-3 mb-md-0 mb-md-n11">
                            <div class="card text-center h-100 transition-3d-hover">
                                <div class="card-body p-lg-5">
                                    <figure class="max-w-8rem w-100 mx-auto mb-4">
                                        <img class="img-fluid" src="/images/commerce/svg/icons/icon-29.svg" alt="SVG">
                                    </figure>
                        ...
                        <div class="row justify-content-sm-center align-items-sm-center mb-5">
                            <div class="col-sm-3">
                                <figure class="max-w-8rem mx-auto mb-2">
                                    <img class="img-fluid" src="/images/commerce/svg/illustrations/diversity.svg" alt="SVG">
                                </figure>
                                <h4>Skills</h4>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <figure class="max-w-8rem mx-auto mb-2">
                                    <img class="img-fluid" src="/images/commerce/svg/illustrations/growth.svg" alt="SVG">
                                </figure>
                                <h4>Confidence</h4>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <figure class="max-w-8rem mx-auto mb-2">
                                    <img class="img-fluid" src="/images/commerce/svg/illustrations/medal.svg" alt="SVG">
                                </figure>
                                <h4>Future</h4>
                            </div>
                        </div>
            ...
            <div class="w-lg-75 mx-lg-auto">
                <div class="media d-block d-sm-flex">
                    <figure class="w-100 max-w-15rem mr-4 mb-3 mb-sm-0">
                        <img class="img-fluid" src="/images/commerce/svg/illustrations/referral.svg" alt="SVG">
                    </figure>
                    <div class="media-body">
        ...
        <div class="space-bottom-2 space-bottom-lg-3" style="background: url('/images/commerce/svg/components/abstract-shapes-9.svg') center no-repeat;">
            <div class="position-relative">
                <div class="container space-2">
                    ...
                    <div class="js-slick-carousel slick slick-equal-height slick-gutters-3 slick-center-mode-right slick-center-mode-right-offset"
                        ...
                        <article class="js-slide pt-2">
                            <div class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" style="background-image: url('/images/commerce/400x500/img14.jpg');">
                                <div class="card-body">
                        ...
                        <article class="js-slide pt-2">
                            <div class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" style="background-image: url('/images/commerce/400x500/img15.jpg');">
                                <div class="card-body">
                                    <span class="d-block small text-white-70 font-weight-bold text-cap mb-2">NEET</span>
                        ...
                        <article class="js-slide pt-2">
                            <div class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" style="background-image: url('/images/commerce/400x500/img16.jpg');">
                                <div class="card-body">
                        ...
                        <article class="js-slide pt-2">
                            <div class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" style="background-image: url('/images/commerce/400x500/img18.jpg');">
                                <div class="card-body">
                                    <span class="d-block small text-white-70 font-weight-bold text-cap mb-2">JEE</span>
