...
@section('content')
    ...
    <main id="content" role="main">
        ...
        <div class="bg-img-hero-center" style="background-image: url({{ cdn_mix('/images/banners/21kgroup-banner.jpeg') }});">
            <div class="container space-3 space-lg-4 space-lg-3">
                <div class="w-xs-auto text-center">
                    <div class="mb-4">
                        <h2 class="h1 text-dark">21K Group</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container space-2 space-lg-0">
            <div class="row">
                <div class="col-lg-12 space-top-lg-2 space-bottom-lg-1">
